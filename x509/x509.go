...
func parseCertificateRequest(in *certificateRequest) (*CertificateRequest, error) {
	algo := getPublicKeyAlgorithmFromOID(in.TBSCSR.PublicKey.Algorithm.Algorithm)
	params, _ := asn1.Marshal(oidNamedCurveP256SM2)
	if algo == ECDSA && reflect.DeepEqual(params, in.TBSCSR.PublicKey.Algorithm.Parameters.FullBytes) {
		algo = SM2
	}
