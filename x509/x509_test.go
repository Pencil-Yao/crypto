...
const sm2pemIssuerCert = `-----BEGIN CERTIFICATE-----

Zj00VYNHvJP7ym+LDmKxm4vkuoLqvumi/Bo2
-----END CERTIFICATE-----`

const sm2pemSubjectCert = `-----BEGIN CERTIFICATE-----

...

-----END CERTIFICATE-----`

func TestSM2Cert(t *testing.T) {

	iblock, _ := pem.Decode([]byte(sm2pemIssuerCert))
	icert, _ := ParseCertificate(iblock.Bytes)

	sblock, _ := pem.Decode([]byte(sm2pemSubjectCert))
	scert, _ := ParseCertificate(sblock.Bytes)

	err := scert.CheckSignatureFrom(icert)
	if err != nil {
		println(err)
	} else {
		println(scert.RawTBSCertificate)
	}
}